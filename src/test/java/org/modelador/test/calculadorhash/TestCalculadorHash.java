...
public class TestCalculadorHash {
    ...
    protected void TestHash256() {
        ...
        EntradaCalculador primeiraEntrada = new EntradaCalculador(
                "Deus Pai",
                "b86db0021291b0c550f0e36bd984fbeec61d415bef506646ccf265f2415ed18d");

        EntradaCalculador segundaEntrada = new EntradaCalculador(
                "Jesus Cristo",
                "257acf5c3065075039c248dac69704f57cb3acfe181af5b1c5864edad93072f5"
        );

        EntradaCalculador terceiraEntrada = new EntradaCalculador(
                "Espírito Santo",
                "3c9ca777dfa3e985e87fc75322ed5134f8907aeee525f47b9058616a1c8b035f"
        );
        ...
        assert !(calculadorHash.calcularHash256(primeiraEntrada.getEntradaBytes()).equals(segundaEntrada.saida()));
    }
    ...
    protected void TestHash512() {
        ...
        // Verificação para ver se os resultados do hash são diferentes
        assert !(calculadorHash.calcularHash512(primeiraEntrada.getEntradaBytes()).equals(segundaEntrada.saida()));
    }
